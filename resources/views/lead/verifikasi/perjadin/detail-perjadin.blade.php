                            ...
                            <div class="card-body">
                                <form action="#">
                                    ...
                                    <div class="row mx-4 my-4">
                                        <div class="col-sm-6">
                                            <a type="button" href="{{ route('perjadinLead') }}"
                                                class="btn btn-secondary">kembali</a>
                                        </div>
                                        <div class="col-sm-6 d-flex justify-content-end">
                                            @if ($detail_perjalanandinas->status == 'Diproses')
                                                <form
                                                    action="{{ route('update-perjadinLead', ['id' => $detail_perjalanandinas->id]) }}"
                                                    method="POST" style="display:inline;">
                                                    @csrf
                                                    <button type="submit" class="btn btn-danger" name="ditolak"
                                                        value="ditolak">Tolak</button>
                                                    <button type="submit" class="btn btn-primary" name="disetujui"
