                            ...
                            <div class="card-body">
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal-spmk"
                                            value="{{ \Carbon\Carbon::parse($barjas->tgl_spmk)->format('d M Y') }}"
                                            readonly>
                                    </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="#" class="view-pdf"
                                                        data-url="{{ Storage::url($barjas->bukti_spmk) }}"
                                                        data-bs-toggle="modal" data-bs-target="#pdfModal">
                                                        Lihat Bukti Laporan SPMK
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal"
                                            value="{{ \Carbon\Carbon::parse($barjas->tgl_pho)->format('d M Y') }}" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="#" class="view-pdf"
                                                        data-url="{{ Storage::url($barjas->bukti_pho) }}"
                                                        data-bs-toggle="modal" data-bs-target="#pdfModal">
                                                        Lihat Bukti Laporan PHO
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal"
                                            value="{{ \Carbon\Carbon::parse($barjas->tgl_bast)->format('d M Y') }}"
                                            readonly>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="#" class="view-pdf"
                                                        data-url="{{ Storage::url($barjas->bukti_bast) }}"
                                                        data-bs-toggle="modal" data-bs-target="#pdfModal">
                                                        Lihat Bukti Laporan BAST
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal"
                                            value="{{ \Carbon\Carbon::parse($barjas->tgl_fho)->format('d M Y') }}"
                                            readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="#" class="view-pdf"
                                                        data-url="{{ Storage::url($barjas->bukti_fho) }}"
                                                        data-bs-toggle="modal" data-bs-target="#pdfModal">
                                                        Lihat Bukti Laporan FHO
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal"
                                            value="{{ \Carbon\Carbon::parse($barjas->tgl_sp2d)->format('d M Y') }}"
                                            readonly>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <ul>
                                                <li>
                                                    <a href="#" class="view-pdf"
                                                        data-url="{{ Storage::url($barjas->bukti_sp2d) }}"
                                                        data-bs-toggle="modal" data-bs-target="#pdfModal">
                                                        Lihat Bukti Laporan SP2D
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="row mx-4 my-4">
                                    <div class="col-sm-6">
                                        <a type="button" href="{{ route('pelaporan-barjas-lead') }}"
                                            class="btn btn-secondary">Kembali</a>
                                    </div>

                                    <div class="col-sm-6 d-flex justify-content-end">
                                        @if ($barjas->status_lapor == 'Diproses')
                                            <form action="{{ route('update-pelaporan-barjas-lead', $barjas->id) }}" method="POST" style="display:inline;">
                                                @csrf
