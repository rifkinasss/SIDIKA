                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info btn-sm viewButton"
                                                        ...
                                                        data-dokumen-rab="{{ Storage::url($p->dokumen_rab) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewModalLabel">Detail Perencanaan Belanja Barang Jasa</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="view-dokumen-rab" class="form-label">Dokumen RAB</label>
                        <ul>
                            <li><a id="view-dokumen-rab" href="#" target="_blank">Lihat
                                    File</a></li>
                        </ul>
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    @if ($p->status == 'Diproses')
                        <form action="{{ route('perencanaan-belanja-barjas.verif', ['id' => $p->id]) }}" method="POST"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            viewButtons.forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    var dokumenRAB = button.getAttribute('data-dokumen-rab');
                    ...
                    var dokumenRABLink = document.getElementById('view-dokumen-rab');
                    dokumenRABLink.href = dokumenRAB

                    var lainnyaWrapper = document.getElementById('view-lainnya-wrapper');
                    if (jnsBelanja === 'Belanja Barang Jasa Lainnya') {
