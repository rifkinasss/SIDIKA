    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Pelaporan Belanja Barang Jasa</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('dashboard-admin') }}">Home</a></li>
                            <li class="breadcrumb-item">Belanja Barang Jasa</li>
                            <li class="breadcrumb-item active">Pelaporan Belanja Barang Jasa</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" id="nomor-spmk"
                                            value="{{ $barjas->nomor_spmk }}" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal-spmk" value="{{ \Carbon\Carbon::parse($barjas->tgl_spmk)->format('d M Y') }}" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <ul>
                                                <li><a href="#" class="view-pdf" data-url="{{ Storage::url($barjas->bukti_spmk) }}" data-bs-toggle="modal" data-bs-target="#pdfModal">Lihat Bukti Laporan SPMK</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" id="nomor-pho"
                                            value="{{ $barjas->nomor_pho }}" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="tanggal" class="form-label">Tanggal</label>
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal" value="{{ \Carbon\Carbon::parse($barjas->tgl_pho)->format('d M Y') }}" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="lampiran-bukti" class="form-label">Lampiran Bukti</label>
                                            <ul>
                                                <li><a href="#" class="view-pdf" data-url="{{ Storage::url($barjas->bukti_pho) }}" data-bs-toggle="modal" data-bs-target="#pdfModal">Lihat Bukti Laporan PHO</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" id="nomor-bast"
                                            value="{{ $barjas->nomor_bast }}" readonly>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="tanggal" class="form-label">Tanggal</label>
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal" value="{{ \Carbon\Carbon::parse($barjas->tgl_bast)->format('d M Y') }}" readonly>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="nilai-bast" class="form-label">Nilai BAST</label>
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="nilai-bast" value="{{ $barjas->nilai_bast }}" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="lampiran-bukti" class="form-label">Lampiran Bukti</label>
                                            <ul>
                                                <li><a href="#" class="view-pdf" data-url="{{ Storage::url($barjas->bukti_bast) }}" data-bs-toggle="modal" data-bs-target="#pdfModal">Lihat Bukti Laporan BAST</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" id="nomor-fho"
                                            value="{{ $barjas->nomor_fho }}" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="tanggal" class="form-label">Tanggal</label>
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal" value="{{ \Carbon\Carbon::parse($barjas->tgl_fho)->format('d M Y') }}" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="lampiran-bukti" class="form-label">Lampiran Bukti</label>
                                            <ul>
                                                <li><a href="#" class="view-pdf" data-url="{{ Storage::url($barjas->bukti_fho) }}" data-bs-toggle="modal" data-bs-target="#pdfModal">Lihat Bukti Laporan FHO</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mx-4 my-4 align-items-start">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control rounded-0 mb-2" id="nomor-sp2d"
                                            value="{{ $barjas->nomor_sp2d }}" readonly>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="tanggal" class="form-label">Tanggal</label>
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="tanggal" value="{{ \Carbon\Carbon::parse($barjas->tgl_sp2d)->format('d M Y') }}" readonly>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="nilai-sp2d" class="form-label">Nilai SP2D</label>
                                        <input type="text" class="form-control rounded-0 mb-2" maxlength="18"
                                            id="nilai-sp2d" value="{{ $barjas->nilai_sp2d }}" readonly>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            <label for="lampiran-bukti" class="form-label">Lampiran Bukti</label>
                                            <ul>
                                                <li><a href="#" class="view-pdf" data-url="{{ Storage::url($barjas->bukti_sp2d) }}" data-bs-toggle="modal" data-bs-target="#pdfModal">Lihat Bukti Laporan SP2D</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mx-4 my-4">
                                    <div class="col-sm-6">
                                        <a type="button" href="{{ route('pelaporan-barang-barjas') }}"
                                            class="btn btn-secondary">Kembali</a>
                                    </div>

                                    <div class="col-sm-6 d-flex justify-content-end">
                                        @if ($barjas->status_lapor == 'Diproses')
                                            <form
                                                action="{{ route('pelaporan-belanja-barjas.kirimNotifPimpinan', ['id' => $barjas->id]) }}"
