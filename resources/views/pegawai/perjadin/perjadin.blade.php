  ...
  <div class="container-fluid py-4 px-4 pb-2 bg-transparent">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="#" class="text-decoration-none text-dark">Home</a></li>
        <li class="breadcrumb-item">Perjalanan Dinas</li>
        <li class="breadcrumb-item active" aria-current="page"><span class="text-first"><u>Pengajuan Perjalanan Dinas</u></span></li>
      </ol>
    </nav>
  </div>
  ...
  <div class="container-fluid bg-transparent">
    <div class="card bg-light rounded-0">
      ...
      <div class="row mx-4 my-4 align-items-start">
        ...
        <div class="col-md-6">
          <label for="uang-harian" class="form-label">Uang Harian</label>
          <input class="form-control rounded-0 mb-2" type="number" id="uang-harian" required />
          <label for="jumlah-uang-harian" class="form-label">Jumlah Uang harian</label>
          <input class="form-control rounded-0 mb-2" type="number" id="jumlah-uang-harian" required />
          <label for="biaya_akomodasi" class="form-label">Biaya Akomodasi</label>
          <input class="form-control rounded-0 mb-2" type="number" id="biaya_akomodasi" required />
          <label for="biaya_lain" class="form-label">Biaya lain /Kontribusi /Bantuan Transport (Jika ada)</label>
          <input class="form-control rounded-0 mb-2" type="number" id="biaya_lain" />
          <label for="biaya_pp" class="form-label">Biaya Tiket Pulang-Pergi</label>
          <input class="form-control rounded-0 mb-2" type="number" id="biaya_pp" required />
          <label for="uang-representasi" class="form-label">Uang Representasi (jika ada)</label>
          <input class="form-control rounded-0 mb-2" type="number" id="uang-representasi" />
          <label for="jumlah-biaya" class="form-label">Jumlah Biaya</label>
          <input class="form-control rounded-0 mb-2" type="number" id="jumlah-biaya" />
        </div>
        <div class="col-md-6">
          <div class="card bg-third border border-primary rounded-0 pt-4 px-4">
            <p><i class="bi bi-info-square-fill"></i> Info
              <ol>
                <li>Nominal uang harian otomatis diambil berdasarkan posisi dan jabatan.</li>
                <li>Jumlah uang harian dikalikan dengan berapa hari perjalanan dinas dilaksanakan.</li>
                <li>Biaya Akomodasi yaitu biaya penyewaan tempat singgah (hotel, motel, penginapan). <b>Untuk Perjalanan Dinas Pindah tidak ada Biaya Akomodasi (ketikkan Rp 0)</b>. Sebagai gantinya bisa mengisi Biaya lain /Kontribusi /Bantuan Transport jika membutuhkan biaya untuk pengangkutan barang ke tempat tujuan.</li>
                <li>Biaya lain /Kontribusi /Bantuan Transport <b></b>hanya untuk Perjalanan Dinas Pindah</li>
                <li>Biaya Tiket Pulang-Pergi merupakan biaya perkiraan. <b>Harap menambahkan catatan Jika terdapat perubahan biaya sewaktu pelaporan nanti.</b></li>
                <li>Uang Representasi <b>(jika ada)</b> Untuk pejabat tertentu yang memiliki tanggung jawab kehumasan atau penyambutan tamu.</li>
              </ol>
            </p>
          </div>
        </div>
      ...
      <div class="row mx-4 my-4 align-items-start">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            <label for="bukti-surat-tugas" class="form-label">Bukti Surat Tugas</label>
            <input class="form-control" type="file" id="bukti-surat-tugas" multiple>
          </div>
        </div>
        <div class="col-md-6">
          <div class="card bg-third border border-primary rounded-0 pt-4 px-4">
            <p><i class="bi bi-info-square-fill"></i> Info
              <ol>
                <li>Bukti Surat Tugas <b>Wajib surat resmi instansi dan ditandatangi oleh atasan.</b> File dikirimkan dalam bentuk .pdf (bisa lebih dari satu file).</li>
              </ol>
            </p>
          </div>
        </div>
