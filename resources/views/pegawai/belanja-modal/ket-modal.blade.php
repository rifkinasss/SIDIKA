                        ...
                        <div class="accordion-item">
                            ...
                            <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body">
                                    <p>Belanja Modal adalah pengeluaran anggaran yang digunakan untuk memperoleh aset tetap
                                        dan aset lainnya yang memberikan manfaat lebih dari satu periode akuntansi.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    <ol>
                                        ...
                                        <li>Belanja Modal Peralatan dan Mesin: Pengeluaran untuk pembelian alat dan mesin
                                            yang bernilai tinggi.</li>
                                        <li>Belanja Modal Gedung dan Bangunan: Pengeluaran untuk pembangunan gedung dan
                                            bangunan baru.</li>
                                        <li>Belanja Modal Jalan, Irigasi, dan Jaringan: Pengeluaran untuk pembangunan
                                            infrastruktur.</li>
                                        <li>Belanja Modal Aset Tetap Lainnya: Pengeluaran untuk pembelian aset tetap lainnya
                                            yang tidak termasuk dalam kategori di atas.</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <ol>
                                        ...
                                        <li>Pelaksanaan: Melaksanakan pengadaan aset sesuai dengan anggaran yang telah
                                            ditetapkan.</li>
