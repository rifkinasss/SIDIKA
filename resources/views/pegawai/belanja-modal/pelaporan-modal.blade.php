  ...
  <div class="container-fluid py-4 px-4 pb-2 bg-transparent">
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><span class="text-first"><u>Pelaporan Belanja Modal</u></span></li>
      </ol>
    </nav>
  </div>
  ...
  <div class="container-fluid bg-transparent mb-4">
    <div class="card bg-light rounded-0">
      ...
      <div class="row py-2 ps-4">
        <p>Lengkapi form dibawah ini beserta deskripsi yang jelas yang dapat menjadi pendukung untuk melengkapi Dokumen-dokumen Pelaporan Belanja Modal.</p>
        <p>
          ...
          Pada Pelaporan Belanja Modal ini bersifat progresif dimana halaman dapat dibuka kembali sampai semua form terisi.
        </p>
      </div>
    ...
    <div class="card bg-light rounded-0">
      <div class="row mx-4 my-4 align-items-start">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control rounded-0 mb-2" id="nomor-spmk-modal" required>
          <label for="tanggal-spmk-modal" class="form-label">Tanggal</label>
          <input type="date" class="form-control rounded-0 mb-2" id="tanggal-spmk-modal" placeholder="DD/MM/YYYY" required>
          <label for="bukti-spmk-modal" class="form-label">Bukti Dokumen Sistem Pelaporan Monitoring Kontrak (.pdf)</label>
          <input class="form-control rounded-0 mb-2" type="file" id="bukti-spmk-modal" multiple>
        </div>
        <div class="col-md-6">
    ...
    <div class="card bg-light rounded-0">
      <div class="row mx-4 my-4 align-items-start">
        ...
        <div class="col-md-6">
          ...
          <input class="form-control rounded-0 mb-2" type="text" id="nomor-pho-modal"  />
          <label for="tanggal-pho-modal" class="form-label">Tanggal PHO</label>
          <input type="date" class="form-control rounded-0 mb-2" id="tanggal-pho-modal" placeholder="DD/MM/YYYY" >
          <label for="bukti-pho-modal" class="form-label">Bukti Dokumen PHO (.pdf)</label>
          <input class="form-control rounded-0 mb-2" type="file" id="bukti-pho-modal" multiple>
        </div>
        <div class="col-md-6">
          <div class="card bg-third border border-primary rounded-0 pt-4 px-4">
            <p><i class="bi bi-info-square-fill"></i> Info
      ...
      <div class="row mx-4 my-4 align-items-start">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="date" class="form-control rounded-0 mb-2" id="tanggal-bast-modal" placeholder="DD/MM/YYYY" >
      ...
      <div class="row mx-4 my-4 align-items-start">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="date" class="form-control rounded-0 mb-2" id="tanggal-fho-modal" placeholder="DD/MM/YYYY" >
      ...
      <div class="row mx-4 my-4 align-items-start">
        ...
        <div class="col-md-6">
          <div class="mb-3">
            ...
            <input type="date" class="form-control rounded-0 mb-2" id="tanggal-sp2d-modal" placeholder="DD/MM/YYYY" >
